...
$al->register('javascript', 'common', 'js/common.js');
$al->register('css', 'manual', 'css/manual-styles.css');
$al->register('css', 'styles', 'css/styles.css');
$al->registerGroup('defaults', array(array('css', 'manual'),array('css', 'styles'),array('javascript', 'common')));

$al->register('javascript', 'bootstrap3', 'js/bootstrap.min.js');
$al->register('css', 'bootstrap3', 'css/bootstrap.min.css');
$al->registerGroup('bootstrap3', array(array('css', 'bootstrap3'),array('javascript', 'bootstrap3')));
